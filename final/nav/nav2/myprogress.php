...
<head>
	...
	<link rel="stylesheet" href="css/myprogress/reset.css"> <!-- CSS reset -->
	<link rel="stylesheet" href="css/myprogress/style.css"> <!-- Resource style -->
    
    <!--modalview-->
    <link rel="stylesheet" href="css/modal/reset.css"> <!-- CSS reset -->
	<link rel="stylesheet" href="css/modal/style.css"> <!-- Resource style -->
	<script src="js/modal/modernizr.js"></script> <!-- Modernizr -->
	...
	<link rel="stylesheet" href="css/nav/reset.css"> <!-- CSS reset -->
	<link rel="stylesheet" href="css/nav/style.css"> <!-- Resource style -->
	<script src="js/modernizr.js"></script> <!-- Modernizr -->
    
	<title>VillGrow Learn</title>
</head>
<body>
	...
	<div class="events-content">
		<ol>
			<li class="selected" data-date="16/01/2014">
				...
				<p>	
					Completed module: Organization with basics.
				</p>
			</li>

			<li data-date="28/02/2014">
				<h2>Earned medal: Basic trainer.</h2>
				<em>February 28th, 2014</em>
				
			</li>

			<li data-date="20/04/2014">
				<h2>Module stated: Managing with time.</h2>
				<em>March 20th, 2014</em>
				
			</li>

			<li data-date="20/05/2014">
				<h2>Completed module 3. Hurray!</h2>
				<em>May 20th, 2014</em>
				
			</li>

			<li data-date="09/07/2014">
				<h2>You completed Ravi's challenge</h2>
				<em>July 9th, 2014</em>
				
			</li>

			<li data-date="30/08/2014">
				<h2>You earned badge: Major! </h2>
			...
			<li data-date="15/09/2014">
				<h2>You completed Anita's challenge</h2>
				<em>September 15th, 2014</em>
			
			</li>

			<li data-date="01/11/2014">
				<h2>Module 3 started.</h2>
				<em>November 1st, 2014</em>
			
			</li>

			<li data-date="10/12/2014">
				<h2>Module 3 completed!</h2>
				<em>December 10th, 2014</em>
			
			</li>

			<li data-date="19/01/2015">
				<h2>Challenged completed!</h2>
...
<script src="js/timeline/jquery-2.1.4.js"></script>
<script src="js/timeline/jquery.mobile.custom.min.js"></script>
<script src="js/timeline/main.js"></script> <!-- Resource jQuery -->
            
            <!--timeline-->
	<div class="cd-cover-layer"></div> <!-- .cd-cover-layer -->
<script src="js/modal/jquery-2.1.4.js"></script>
<script src="js/modal/snap.svg-min.js"></script>
<script src="js/modal/main.js"></script> <!-- Resource jQuery -->
    <!--modalview ends-->
		...
		<ul class="cd-radial-slider" data-radius1="60" data-radius2="1364" data-centerx1="110" data-centerx2="1290">
			<li class="visible">
				...
				<div class="cd-radial-slider-content">
					<div class="wrapper">
						<div>
							<h2>Module: Processes within processes</h2>
							<p>Something about the course.</p>
							<p>Something about the course.</p>
							<a href="#0" class="cd-btn">Start Module</a>
						</div>
					</div>
				...
				<div class="cd-radial-slider-content">
					<div class="wrapper">
						<div>
							<h2>End of course</h2>
							<p>Congrats!</p>
							<p>You've done it soldier!</p>
                          
                             <button onclick="myFunction()">  <a href="./challenge.php" class="cd-btn">Finish</a></button>

<p id="demo"></p>

<script>
function myFunction() {
    var person = prompt("Please enter std SSI value to mark end of course.");
...
<script>
	if( !window.jQuery ) document.write('<script src="js/myprogress/jquery-2.2.1.min.js"><\/script>');
</script>
<script src="js/myprogress/snap.svg-min.js"></script>
<script src="js/myprogress/main.js"></script> <!-- Resource jQuery -->
			<a href="#0" class="cd-btn" id="modal-trigger" data-type="cd-modal-trigger">Continue current course</a>
		</section>
	...
	<div class="cd-modal" data-modal="modal-trigger">
		...
		data-step6="M476.4,1013.4L205,580.3c-0.1-0.1,0-0.3,0.1-0.3L1130.5,0.2c0.1-0.1,0.3,0,0.3,0.1l271.4,433.1c0.1,0.1,0,0.3-0.1,0.3 l-925.4,579.8C476.6,1013.6,476.5,1013.5,476.4,1013.4z">
			<svg height="100%" width="100%" preserveAspectRatio="none" viewBox="0 0 800 500">
				<title>Model 3: Getting started with organisation</title>
		...
		<iframe width="374" height="180" src="https://www.youtube.com/embed/2XkV6IpV2Y0" frameborder="0" allowfullscreen></iframe>
            <br><br>
        <center><a href="./index.php"><button>Go to Home</button></a></center>
