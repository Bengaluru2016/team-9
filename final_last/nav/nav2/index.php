...
<head>
   ...
   <!-- svg-->
    	<link rel="stylesheet" href="css/svg/reset.css"> <!-- CSS reset -->
	<link rel="stylesheet" href="css/svg/style.css"> <!-- Resource style -->
	<script src="js/svg/modernizr.js"></script> <!-- Modernizr -->
...
<body>
	...
	<main class="cd-main-content">
			...
			<ul>
				...
				<li class="has-children bookmarks">
					...
					<ul>
						...
						<li><a href="./myprogress.php">Browse my courses</a></li>
		...
		<header>
	<h1>Learning was never fun before!</h1>
</header>
...
<script src="js/svg/snap.svg-min.js"></script>
<script src="js/svg/main.js"></script> <!-- Resource jQuery -->
		</div> <!-- .content-wrapper -->
