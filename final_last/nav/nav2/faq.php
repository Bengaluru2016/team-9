...
<head>
	...
	<link rel="stylesheet" href="css/leader/reset-faq.css"> <!-- CSS reset -->
	<link rel="stylesheet" href="css/leader/style-faq.css"> <!-- Resource style -->
	<script src="js/leader/modernizr-faq.js"></script> <!-- Modernizr -->
...
<body>
		...
		<nav class="cd-side-nav">
			<ul>
				...
				<li class="has-children overview">
					<a href="./myprogress.html">Overview</a>
					
					<ul>
						<li><a href="./Leaderboard.html">Leaderboard</a></li>
						<li><a href="./faq.html">User Forum</a></li><li><a href="./progress.html">My track</a></li>
				...
				<li class="has-children notifications active">
					...
					<ul>
						<li><a href="./myprogress.html">Courses</a></li>
				...
				<li class="has-children comments">
					...
					<ul>
						...
						<li><a href="./myprogress.html">My Courses</a></li>
			...
			<ul>
				...
				<li class="has-children bookmarks">
					...
					<ul>
						<li><a href="./allcourses.html">Browse all Courses</a></li>
						<li><a href="./myprogress.html">Browsse my courses</a></li>
	...
	<ul class="cd-faq-categories">
		<li><a class="selected" href="#basics">What is economic value in module 3 quiz 2?</a></li>
		<li><a href="#mobile">Anyone crossed module 5 extra quiz 4?</a></li>
		<li><a href="#account">Can I ignore certainity methods?</a></li>
		<li><a href="#payments">How do reviews work?</a></li>
		<li><a href="#privacy">Privacy issues and legal.</a></li>
		<li><a href="#delivery">How does syncing work?</a></li>
        <li><a class="selected" href="#basics">What is economic value in module 3 quiz 21?</a></li>
		<li><a href="#mobile">module 15 extra quiz 4?</a></li>
		<li><a href="#account">legal methods?</a></li>
		<li><a href="#payments">How do issue raising work?</a></li>
		<li><a href="#privacy">Privacy issues and legal.</a></li>
		<li><a href="#delivery">How does syncing work?</a></li>
	...
	<div class="cd-faq-items">
		<ul id="basics" class="cd-faq-group">
			<li class="cd-faq-title"><h2>What is economic value in module 3 quiz 2?</h2></li>
			<li>
				<a class="cd-faq-trigger" href="#0">How do I look sustainbility factor?</a>
			...
			<li>
				<a class="cd-faq-trigger" href="#0">Anyone crossed module 5 extra quiz 4?</a>
				<div class="cd-faq-content">
			...
			<li>
				<a class="cd-faq-trigger" href="#0">Can I remove certainity?</a>
				<div class="cd-faq-content">
...
<script src="js/leader/jquery-2.1.1.js"></script>
<script src="js/leader/jquery.mobile.custom.min.js"></script>
<script src="js/leader/main-faq.js"></script> <!-- Resource jQuery -->
		</div> <!-- .content-wrapper -->
